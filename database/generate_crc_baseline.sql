...
-- Create a table to store baseline data counts and MD5 checksums for each table
CREATE TABLE expected_values (
    table_name VARCHAR(50) PRIMARY KEY,  -- Name of the table
    recs INT NOT NULL,                   -- Number of records in the table
    crc_md5 VARCHAR(100) NOT NULL        -- MD5 checksum of table data content
);
...
-- Initialize checksum accumulator variable to empty string
SET @crc = '';

-- Compute running MD5 checksum for all rows in 'address' table ordered by address_id
...
-- Insert baseline record count and checksum into expected_values table
INSERT INTO expected_values VALUES ('address', (SELECT COUNT(*) FROM address), @crc);
...
INSERT INTO expected_values VALUES ('brand', (SELECT COUNT(*) FROM brand), @crc);
...
INSERT INTO expected_values VALUES ('colour', (SELECT COUNT(*) FROM colour), @crc);
...
INSERT INTO expected_values VALUES ('customer_order', (SELECT COUNT(*) FROM customer_order), @crc);
...
INSERT INTO expected_values VALUES ('customer_order_line', (SELECT COUNT(*) FROM customer_order_line), @crc);
...
INSERT INTO expected_values VALUES ('product', (SELECT COUNT(*) FROM product), @crc);
...
INSERT INTO expected_values VALUES ('product_category', (SELECT COUNT(*) FROM product_category), @crc);
...
INSERT INTO expected_values VALUES ('size', (SELECT COUNT(*) FROM size), @crc);
...
INSERT INTO expected_values VALUES ('supplier', (SELECT COUNT(*) FROM supplier), @crc);
...
INSERT INTO expected_values VALUES ('supplier_order', (SELECT COUNT(*) FROM supplier_order), @crc);
...
INSERT INTO expected_values VALUES ('supplier_order_line', (SELECT COUNT(*) FROM supplier_order_line), @crc);
...
INSERT INTO expected_values VALUES ('user_account', (SELECT COUNT(*) FROM user_account), @crc);
...
INSERT INTO expected_values VALUES ('user_address', (SELECT COUNT(*) FROM user_address), @crc);

-- Drop temporary checksum table as it is no longer needed
