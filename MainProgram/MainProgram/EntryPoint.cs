...
*  
*  File: Program.cs
*  Description: This file contains the main entry point of the application. It 
*               demonstrates various C# concepts such as delegates, lambda 
*               expressions, generics, enums, LINQ operations, and interface-based 
*               programming.
*  
*  Author: Shreya S G
...
*  
*  NOTE:
*  - This class serves as a learning example combining different C# features.
*  - Delegates are used to demonstrate callback and lambda execution.
*  - LINQ is used to perform operations on arrays.
************************************************************************************/
using Automator;
using MainProgram;
using Models;
...
{
    /// <summary>
    /// Delegate representing a method with no parameters and no return type.
    /// </summary>
    public delegate void MyMethodwithNoArguments();

    /// <summary>
    /// Delegate representing a method that accepts a <see cref="DayOfWeek"/> parameter.
    /// </summary>
    public delegate void MyMethodwithDayOfWeek(DayOfWeek inst);

    /// <summary>
    /// Delegate representing a method that takes two integers and returns an integer.
    /// </summary>
    public delegate int AMethodWith2IntsReturnInt(int a, int b);

    /// <summary>
    /// Entry point of the program.
    /// Demonstrates usage of delegates, LINQ operations, generic classes, and interface-based design.
    /// </summary>
    ...
    /// <summary>
    /// Demonstrates handling command-line arguments with a switch statement.
    /// </summary>
    ...
    /// <summary>
    /// Simple method used for delegate demonstration.
    /// </summary>
    static void Method1()
    {
    ...
    /// <summary>
    /// Executes the provided action, wrapping it with pre- and post-execution messages.
    /// </summary>
    ...
    /// <summary>
    /// Demonstrates using the <see cref="GenericCalculator{T}"/> class with different types.
    /// </summary>
    ...
    /// <summary>
    /// Prints a greeting message based on the day of the week.
    /// </summary>
    ...
    /// <summary>
    /// Demonstrates interface-based programming by launching a browser using IBrowsable.
    /// </summary>
    ...
    /// <summary>
    /// Adds two integers after modifying them.
    /// </summary>
